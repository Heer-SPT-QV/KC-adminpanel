...
import CategoryHeader from './bannerHeader';
	...
	useDeepCompareEffect(() => {
		function updateProductState() {
			...
			if (bannerId === 'new') {
				 ...
				 * Get Product data
				 */
				dispatch(getCategory(bannerId)).then(action => {
					/**
		...
		return (
			...
			>
				<Typography color="textSecondary" variant="h5">
					There are no such Banners!
				</Typography>
				<Button className="mt-24" component={Link} variant="outlined" to="/banners" color="inherit">
