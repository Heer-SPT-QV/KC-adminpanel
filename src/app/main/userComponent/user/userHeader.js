...
import { removeCategory, saveCategory } from '../store/projectSlice';
			...
			<div className="flex flex-col items-start max-w-full min-w-0">
				<motion.div initial={{ x: 20, opacity: 0 }} animate={{ x: 0, opacity: 1, transition: { delay: 0.3 } }}>
					...
					>
						...
						<span className="hidden mx-4 font-medium sm:flex">Users</span>
					</Typography>
				</motion.div>
			...
			>
				...
				{!props.isOldProduct && (
					<Button
						...
						variant="contained"
						color="secondary"
						disabled={_.isEmpty(dirtyFields) || !isValid || !getValues('imageUrl').length}
